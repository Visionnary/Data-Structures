...
/**
 * Setter function for the Servant class
 * 
 * @param name - name of servant
 * 
 * @param class1 - class of servant
 * 
 * @param rank - rank of servant
 * 
 * @param nP - noble phantasm of servant
 * 
 * @returns null
 */
